...
public class TeacherRecord extends javax.swing.JFrame {
    ...
    private void Get_Data(){
        String sql = "select TeacherID as Teacher_ID , FirstName as First_Name , LastName as Last_Name, FatherName as Father_Name, DateOfBirth as D_B ,Salary as Salary, Designation as Designation, AcademicQualification as Academic_Qualification, Address as Address, Gender as Gender1 from TeacherRecord";
        try{
    ...
    private void initComponents() {
        ...
        dataTableTeacher.setBackground(new java.awt.Color(153, 153, 153));
    ...
    private void dataTableTeacherMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dataTableTeacherMouseClicked
            ...
            if(rs.next()){
               ...
               String add4=rs.getString("FatherName");
                ...
                teacher.saveButton.setEnabled(true);
            }
